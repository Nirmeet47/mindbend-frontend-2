...
const defaultOptions: HyperspeedOptions = {
  ...
  colors: {
    roadColor: 0x0a0a14, // Dark blue-black for road
    islandColor: 0x080812, // Slightly darker blue-black for island
    background: 0x000010, // Deep blue-black background
    shoulderLines: 0x1e40af, // Royal blue for shoulder lines
    brokenLines: 0x3b82f6, // Bright blue for broken lines
    leftCars: [0x1d4ed8, 0x1e40af, 0x1e3a8a], // Blue variations for left cars
    rightCars: [0x0ea5e9, 0x0284c7, 0x0369a1], // Blue variations for right cars
    sticks: 0x3b82f6, // Bright blue for sticks
  },
};
...
class App {
  ...
  constructor(container: HTMLElement, options: HyperspeedOptions) {
    ...
    this.renderer.domElement.classList.add("hyperspeed-canvas");
    this.renderer.domElement.style.position = "absolute";
    this.renderer.domElement.style.top = "0";
    this.renderer.domElement.style.left = "0";
    this.renderer.domElement.style.width = "100%";
    this.renderer.domElement.style.height = "100%";
    this.renderer.domElement.style.pointerEvents = "none"; // ensures UI stays clickable
    this.renderer.domElement.style.zIndex = "-1"; // CHANGED: Lower z-index for background
  ...
  return (
    <div
      ...
      style={{
        position: "fixed",
        inset: 0,
        zIndex: -1, // CHANGED: Fixed position with negative z-index
        pointerEvents: "none",
      }}
    />
  );
